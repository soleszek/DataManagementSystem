...
<div id="container">
    ...
    <div id="content">
        ...
        <table>
            ...
            %>
            <tr>
                <td><input type="checkbox" name="markedUser" value="<%=u.getId()%>"></td>
    ...
    <div id="modal-wrapper-deleteuser" class="modal">
        ...
        <form class="modal-content animate" action="DeleteUser" method="post" enctype="multipart/form-data">

            <div class="imgcontainer">
                <span onclick="document.getElementById('modal-wrapper-deleteuser').style.display='none'" class="close"
                      title="Close PopUp">&times;</span>
                <img src="style/delete-user.jpg" alt="Document" class="avatar">
                <h1 style="text-align:center">Delete user</h1>
            </div>

            <div class="container"><h3 style="text-align:left; margin-left: 24px; padding-top: 35px; padding-bottom: 15px">You about to deleting user , </h3>
